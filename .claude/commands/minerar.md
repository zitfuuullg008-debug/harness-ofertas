...
6. `git add saidas index.html data/vistos.json data/raw && git commit -m \"mineração <hoje>: <nomes>\" && git pull --rebase origin main && git push origin HEAD:main`
7. Termine com as recomendadas (página → 1 frase) e o link https://zitfuuullg008-debug.github.io/harness-ofertas/"
